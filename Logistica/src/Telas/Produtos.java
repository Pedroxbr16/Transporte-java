...
public class Produtos extends JFrame {
	...
	public Produtos() {
		...
		txtquantidade.setBounds(117, 172, 130, 19);
		...
		JButton btnConsultaDePedidos = new JButton("Consulta de Produtos");
		btnConsultaDePedidos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ConsultaProdutos abrir = new ConsultaProdutos();
		...
		btnConsultaDePedidos.setBounds(33, 282, 173, 38);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String inserir = "INSERT INTO usuario (codigo, nome, descrição, quantidade, fornecedor, bairro, cidade) VALUES (?, ?, ?, ?, ?, ?, ?)";
