...
public class CadastroLogin extends JFrame {
	...
	public CadastroLogin() {
		...
		lblNewLabel.setBounds(53, 80, 46, 14);
		contentPane.add(lblNewLabel);
		
		txtcpf = new JTextField();
		txtcpf.setBounds(99, 77, 118, 20);
		...
		txtnome.setBounds(100, 118, 148, 20);
		...
		lblNewLabel_1_1.setBounds(53, 158, 46, 14);
		contentPane.add(lblNewLabel_1_1);
		
		txtemail = new JTextField();
		txtemail.setBounds(100, 157, 148, 20);
		...
		lblNewLabel_2.setBounds(280, 80, 46, 14);
		contentPane.add(lblNewLabel_2);
		
		txtsenha = new JTextField();
		txtsenha.setBounds(346, 77, 125, 20);
		contentPane.add(txtsenha);
		txtsenha.setColumns(10);
		
		JLabel lblNewLabel_2_1 = new JLabel("Setor");
		lblNewLabel_2_1.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblNewLabel_2_1.setForeground(new Color(255, 255, 255));
		lblNewLabel_2_1.setBounds(280, 120, 46, 14);
		contentPane.add(lblNewLabel_2_1);
		
		JComboBox txtsetor = new JComboBox();
		txtsetor.setBounds(346, 116, 125, 22);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String inserir = "INSERT INTO usuario (cpf, nome, email, senha, setor) VALUES (?, ?, ?, ?, ?)";
